...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="bread-crumb p-3" >
                ...
                <a href="/category/{{ $room->roomtype->id }}-{{ Str::slug($room->roomtype->name) }}.html" style="color:#0080C4;">
                    {{ $room->roomtype->name }}
                    <i class="fa-solid fa-angle-right" style="color:#000000;"></i>
                </a>
                {{ $title }}
                    ...
                    <form action=""  class="form">                
                        ...
                        <div class="booking__time--come">
                            ...
                            <div class="booking__number booking">
                                ...
                                <div class="">
                                    <input name="night" id="" class="" type="number" placeholder="Enter a number" required="" aria-required="true" aria-invalid="true" autocomplete="off" value="">
                                </div>
                            </div>
                        </div>
    ...
    <h2 class="text-center mt-5"><i>-~~ Related rooms ~-~</i></h2>
    <div class="session__two">
