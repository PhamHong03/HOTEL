...
<head>
    ...
    <link rel="stylesheet" href="{{asset('set/style.css')}}">
    <link rel="stylesheet" href="{{asset('set/header.css')}}">
    <link rel="stylesheet" href="{{asset('set/footer.css')}}">
    <link rel="stylesheet" href="{{asset('set/register_login.css')}}">
    <link rel="stylesheet" href="{{asset('set/book.css')}}">
    <link rel="stylesheet" href="{{asset('set/rooms.css')}}">
